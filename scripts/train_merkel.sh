...
: ${OUTPUT_DIR:="./output_merkel"}
: ${LOG_FILE:=$OUTPUT_DIR/nvlog.json}
: ${DATASET_PATH:=/raid/dsaha/Merkel_one}
: ${TRAIN_FILELIST:=filelists/merkel_audio_pitch_text_train_v2.txt}
: ${VAL_FILELIST:=filelists/merkel_audio_pitch_text_val_v2.txt}
: ${AMP:=false}
: ${SEED:=""}
